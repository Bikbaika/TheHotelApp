...
namespace TheHotelApp.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Number,RoomTypeID,Description")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ID,Number,RoomTypeID,Description")] Room room)
        {
            if (id != room.ID)
            {
                return NotFound();
